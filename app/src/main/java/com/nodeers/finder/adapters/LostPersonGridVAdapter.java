...
public class LostPersonGridVAdapter extends ArrayAdapter<LostPersonDataModel> {


    public LostPersonGridVAdapter(@NonNull Context context, ArrayList<LostPersonDataModel> dataModalArrayList) {
    ...
    public LostPersonGridVAdapter(@NonNull Context context, int resource, int textViewResourceId) {
